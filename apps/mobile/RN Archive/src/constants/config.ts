...
export const SOCKET_URL = __DEV__
  ...
  : 'https://api.thulobazaar.com'; // Production

// App Colors (matching web - Rose/Pink theme)
export const COLORS = {
  primary: '#ec4899',      // Rose 500 - matches web
  primaryDark: '#db2777',  // Rose 600
  primaryLight: '#f9a8d4', // Rose 300
  secondary: '#764ba2',
  success: '#10b981',
  warning: '#f59e0b',
  error: '#dc2626',
