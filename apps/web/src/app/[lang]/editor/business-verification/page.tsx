...
export default function BusinessVerificationPage({
  ...
  const {
    ...
    openRejectModal,
    closeRejectModal,
  } = useBusinessVerificationPage(params.lang);
    ...
    >
      <div className="space-y-6">
        ...
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          <div>
            <h1 className="text-2xl sm:text-3xl font-bold text-gray-900">Business Verification</h1>
          ...
          {verifications.length === 0 ? (
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-12 text-center">
              ...
              <p className="text-gray-600">
                {activeTab === 'pending'
                  ? 'All business verification requests have been processed'
                  : activeTab === 'rejected'
                    ? 'No business verification applications have been rejected'
