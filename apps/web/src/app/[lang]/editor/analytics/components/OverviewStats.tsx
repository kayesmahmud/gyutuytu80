...
export default function OverviewStats({ overview }: OverviewStatsProps) {
  ...
  return (
    <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
      <div className="bg-gradient-to-br from-blue-50 to-blue-100 border-2 border-blue-200 rounded-xl p-3 sm:p-6">
        <div className="flex items-center justify-between">
          <div>
            <div className="text-xs sm:text-sm font-medium text-blue-700 mb-1">Total Reviewed</div>
      ...
      <div className="bg-gradient-to-br from-green-50 to-green-100 border-2 border-green-200 rounded-xl p-3 sm:p-6">
        <div className="flex items-center justify-between">
          <div>
            <div className="text-xs sm:text-sm font-medium text-green-700 mb-1">Approval Rate</div>
      ...
      <div className="bg-gradient-to-br from-red-50 to-red-100 border-2 border-red-200 rounded-xl p-3 sm:p-6">
        <div className="flex items-center justify-between">
          <div>
            <div className="text-xs sm:text-sm font-medium text-red-700 mb-1">Rejected</div>
      ...
      <div className="bg-gradient-to-br from-purple-50 to-purple-100 border-2 border-purple-200 rounded-xl p-3 sm:p-6">
        <div className="flex items-center justify-between">
          <div>
            <div className="text-xs sm:text-sm font-medium text-purple-700 mb-1">Verifications</div>
      ...
      <div className="bg-gradient-to-br from-teal-50 to-teal-100 border-2 border-teal-200 rounded-xl p-3 sm:p-6">
        <div className="flex items-center justify-between">
          <div>
            <div className="text-xs sm:text-sm font-medium text-teal-700 mb-1">Avg Response Time</div>
      ...
      <div className="bg-gradient-to-br from-orange-50 to-orange-100 border-2 border-orange-200 rounded-xl p-3 sm:p-6">
        <div className="flex items-center justify-between">
          <div>
            <div className="text-xs sm:text-sm font-medium text-orange-700 mb-1">Support Tickets</div>
