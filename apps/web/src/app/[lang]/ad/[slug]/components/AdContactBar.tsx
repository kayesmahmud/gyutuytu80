  ...
  return (
    ...
    >
      <div className="flex items-center justify-around py-2 px-4 gap-2">
        ...
        <button
          onClick={handlePhone}
          className="flex-1 min-w-0 flex items-center justify-center gap-1 py-3 text-sm bg-emerald-500 hover:bg-emerald-600 text-white rounded-xl font-medium transition-colors"
        >
        ...
        <button
          ...
          className="flex-1 min-w-0 flex items-center justify-center gap-1 py-3 text-sm bg-indigo-500 hover:bg-indigo-600 disabled:bg-indigo-300 text-white rounded-xl font-medium transition-colors"
        >
          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path
              strokeLinecap="round"
          ...
          <span>{isMessaging ? '...' : 'Chat'}</span>
        </button>

        {/* WhatsApp */}
        <button
          onClick={handleWhatsApp}
          className="flex-1 min-w-0 flex items-center justify-center gap-1 py-3 text-sm bg-[#25D366] hover:bg-[#1da851] text-white rounded-xl font-medium transition-colors"
        >
