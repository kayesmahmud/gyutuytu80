    ...
    <div className="bg-white rounded-2xl sm:rounded-3xl p-4 sm:p-6 md:p-8 lg:p-12 shadow-xl">
      <div className="text-center mb-6 sm:mb-8 md:mb-10">
        <div className="inline-flex items-center gap-2 bg-gradient-to-r from-indigo-100 to-purple-100 px-3 sm:px-4 py-1.5 sm:py-2 rounded-full mb-3 sm:mb-4">
          ...
          <span className="font-bold text-indigo-900 text-sm sm:text-base">{t('faqTitle')}</span>
        </div>
        <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-gray-900">{t('faqSubtitle')}</h2>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4 md:gap-6">
        ...
        <FaqItem
          ...
          answer={
            <>
              <strong>{t('faqDocsA_individual')}</strong> {t('faqDocsA_individualDesc')}<br />
              <strong>{t('faqDocsA_business')}</strong> {t('faqDocsA_businessDesc')}
            </>
          }
        />
